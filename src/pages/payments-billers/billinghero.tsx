...
import HeroImage from "@/assets/billing-hero.jpg";
...
const HeroSection: React.FC<HeroSectionProps> = ({
  categoryTitle,
  tagline = "Get Paid Accurately, Every Time!",
  title = "Subscription management and billing optimization designed for reliability, transparency, and fraud prevention.",
