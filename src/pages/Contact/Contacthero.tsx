...
import HeroImage from "@/assets/contact-us-1.jpg";
...
const HeroSection: React.FC<HeroSectionProps> = ({
  tagline = "Reach Out! We are Always Here.",
  title = "We would love to hear from you. Your feedback, opinions, and enquiries matter to us.",
